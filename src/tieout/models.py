...
# Finding types
(DUPLICATE, UNCLAIMED_CREDIT, TIMING, UNRECORDED_LIABILITY, PART_PAYMENT,
 AMOUNT_MISMATCH, PAYMENT_NOT_APPLIED, SUPPLIER_OMISSION, CURRENCY_MISMATCH) = (
    "DUPLICATE", "UNCLAIMED_CREDIT", "TIMING", "UNRECORDED_LIABILITY",
    "PART_PAYMENT", "AMOUNT_MISMATCH", "PAYMENT_NOT_APPLIED",
    "SUPPLIER_OMISSION", "CURRENCY_MISMATCH")

# Buckets, in fixed report order
CASH_AT_RISK, UNRECORDED_LIABILITY_BUCKET, INVESTIGATE, EXPLAINED = BUCKET_ORDER = (
    "cash_at_risk", "unrecorded_liability", "investigate", "explained")
